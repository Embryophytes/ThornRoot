...
impl Table {
    ...
    pub fn add_column(&mut self, _column: Column, _save_with_error: bool) -> Result<&mut Self, String> {
        Ok(self)
    }

    /// updates the column in the table (TODO)
    pub fn update_column(&mut self, _updated_column: Column, _save_with_error: bool) -> Result<&mut Self, String> {
        Ok(self)
    }
